//! HTML report generator for `RapidTriage`.
//!
//! Produces self-contained HTML reports from forensic timeline data stored
//! in a [`TimelineStore`](rt_timeline::store::TimelineStore). The report
...
impl Default for ReportConfig {
    fn default() -> Self {
        Self {
            title: "RapidTriage Report".to_string(),
            case_id: None,
            examiner: None,
...
pub fn collect_report_data(
    store: &rt_timeline::store::TimelineStore,
    config: ReportConfig,
...
<div class="meta">"#,
    ...
    let _ = write!(
        ...
        r"</div>
<footer>
Generated by RapidTriage &middot; {generated}
</footer>
",
...
mod tests {
    ...
    fn test_report_config_default() {
        ...
        assert_eq!(cfg.title, "RapidTriage Report");
    ...
    fn test_render_html_empty() {
        ...
        assert!(
            html.contains("RapidTriage Report"),
            "should contain the title"
        );
        assert!(
            html.contains("Generated by RapidTriage"),
    ...
    fn test_collect_report_data_with_findings() {
        ...
        let finding_rows = vec![rt_timeline::findings::FindingRow {

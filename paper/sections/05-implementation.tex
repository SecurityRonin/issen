...
Propositions~\ref{thm:parser-indep}~and~\ref{thm:layer-rule}.
...
The crate boundaries enforce Proposition~\ref{thm:layer-rule} mechanically.
...
Proposition~\ref{thm:parser-indep} naturally: the registry is a set of $\Bstar
...
Proposition~\ref{thm:parser-indep}'s standpoint there is only one parser; the

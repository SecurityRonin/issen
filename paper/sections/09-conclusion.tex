...
uniformly with all five primitives (Proposition~\ref{thm:parser-indep}); we
derived from that theorem a layer-dependency rule that constrains how
forensic software is to be organized (Proposition~\ref{thm:layer-rule}); we
...
the source (Proposition~\ref{thm:parser-indep}), can apply source-appropriate

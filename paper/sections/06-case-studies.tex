...
Proposition~\ref{thm:parser-indep}: the same Chrome history file is read
...
function across all four invocations. By Proposition~\ref{thm:parser-indep},
...
alongside this paper. Proposition~\ref{thm:parser-indep} predicts that
re-running the verification yields the same prefixes; any deviation
falsifies the empirical claim.

\paragraph{Interpretation.}
Proposition~\ref{thm:parser-indep} predicts identical parser output for
...
the kind of incidental complexity that Proposition~\ref{thm:layer-rule} forbids

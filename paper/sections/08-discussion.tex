...
cannot. Proposition~\ref{thm:partial-complete} establishes partial completeness
...
Proposition~\ref{thm:partial-complete} assumes; whether quantum substrates
...
The empirical demonstration of Proposition~\ref{thm:parser-indep}
...
propose as future work -- would re-implement Proposition~\ref{thm:parser-indep}'s
...
Proposition~\ref{thm:parser-indep} (Section~\ref{sec:case3}) is a single-host,
